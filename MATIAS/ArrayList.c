 ...
 * \return int Return (-1) if Error [pList or pElement are NULL pointer] - (index to element) if Ok
 */
int al_indexOfElement(ArrayList* this, void* pElement, int(*fnComparar)(void*, void*))
{
    int i;
...
int resizeUp(ArrayList* this)
{
    if(this != NULL)
    {
        void** auxPElements = realloc(this->pElements,sizeof(void*)* (this->reservedSize + AL_INCREMENT));
